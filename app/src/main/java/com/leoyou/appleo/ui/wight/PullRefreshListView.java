package com.leoyou.appleo.ui.wight;
...
public class PullRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private SwipeRefreshLayout.OnRefreshListener mOnRefershListener;
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.list_header, null);
